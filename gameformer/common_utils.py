...
def build_metrics_aggregators(experiment, output_dir, aggregator_metric_dir):
    ...
    metric_aggregators.append(
        WeightedAverageMetricAggregator(name, metric_weights, file_name, aggregator_save_path, multiple_metrics))
...
def get_low_level_metrics():
    low_level_metrics = {
        ...
        'ego_expert_L2_error': EgoExpertL2ErrorStatistics(name='ego_expert_L2_error', category='Planning',
                                                          discount_factor=1),
        'ego_expert_l2_error_with_yaw': EgoExpertL2ErrorWithYawStatistics(name='ego_expert_l2_error_with_yaw',
                                                                          category='Planning', discount_factor=1),
        ...
        'ego_lat_acceleration': EgoLatAccelerationStatistics(name='ego_lat_acceleration', category='Dynamics',
                                                             max_abs_lat_accel=4.89),
        'ego_lat_jerk': EgoLatJerkStatistics(name='ego_lat_jerk', category='Dynamics'),
        'ego_lon_acceleration': EgoLonAccelerationStatistics(name='ego_lon_acceleration', category='Dynamics',
                                                             min_lon_accel=-4.05, max_lon_accel=2.40),
        ...
        'ego_progress_along_expert_route': EgoProgressAlongExpertRouteStatistics(name='ego_progress_along_expert_route',
                                                                                 category='Planning',
                                                                                 score_progress_threshold=2),
        'ego_yaw_acceleration': EgoYawAccelerationStatistics(name='ego_yaw_acceleration', category='Dynamics',
...
def get_high_level_metrics(low_level_metrics):
    high_level_metrics = {
        'drivable_area_compliance': DrivableAreaComplianceStatistics(name='drivable_area_compliance',
                                                                     category='Planning',
                                                                     lane_change_metric=low_level_metrics[
                                                                         'ego_lane_change'],
                                                                     max_violation_threshold=0.3,
                                                                     metric_score_unit='bool'),
        'driving_direction_compliance': DrivingDirectionComplianceStatistics(name='driving_direction_compliance',
                                                                             category='Planning',
                                                                             lane_change_metric=low_level_metrics[
                                                                                 'ego_lane_change'],
                                                                             metric_score_unit='bool'),
        'ego_is_comfortable': EgoIsComfortableStatistics(name='ego_is_comfortable', category='Violations',
                                                         metric_score_unit='bool',
                                                         ego_jerk_metric=low_level_metrics['ego_jerk'],
                                                         ego_lat_acceleration_metric=low_level_metrics[
                                                             'ego_lat_acceleration'],
                                                         ego_lon_acceleration_metric=low_level_metrics[
                                                             'ego_lon_acceleration'],
                                                         ego_lon_jerk_metric=low_level_metrics['ego_lon_jerk'],
                                                         ego_yaw_acceleration_metric=low_level_metrics[
        ...
        'ego_is_making_progress': EgoIsMakingProgressStatistics(name='ego_is_making_progress', category='Planning',
                                                                ...
                                                                low_level_metrics['ego_progress_along_expert_route'],
                                                                metric_score_unit='bool', min_progress_threshold=0.2),
        'no_ego_at_fault_collisions': EgoAtFaultCollisionStatistics(name='no_ego_at_fault_collisions',
                                                                    category='Dynamics', metric_score_unit='float',
                                                                    ego_lane_change_metric=low_level_metrics[
                                                                        'ego_lane_change']),
        'planner_expert_average_heading_error_within_bound': PlannerExpertAverageHeadingErrorStatistics(
            ...
            planner_expert_average_l2_error_within_bound_metric=low_level_metrics[
                'planner_expert_average_l2_error_within_bound']),
        'planner_expert_final_heading_error_within_bound': PlannerExpertFinalHeadingErrorStatistics(
            ...
            planner_expert_average_l2_error_within_bound_metric=low_level_metrics[
                'planner_expert_average_l2_error_within_bound']),
        'planner_expert_final_l2_error_within_bound': PlannerExpertFinalL2ErrorStatistics(
            name='planner_expert_final_l2_error_within_bound', category='Planning',
            metric_score_unit='float', max_final_l2_error_threshold=8,
            planner_expert_average_l2_error_within_bound_metric=low_level_metrics[
                'planner_expert_average_l2_error_within_bound']),
        'planner_miss_rate_within_bound': PlannerMissRateStatistics(name='planner_miss_rate_within_bound',
                                                                    category='Planning', metric_score_unit='bool',
                                                                    max_displacement_threshold=[6.0, 8.0, 16.0],
                                                                    max_miss_rate_threshold=0.3,
                                                                    planner_expert_average_l2_error_within_bound_metric=
                                                                    low_level_metrics[
                                                                        'planner_expert_average_l2_error_within_bound']),
        'speed_limit_compliance': SpeedLimitComplianceStatistics(name='speed_limit_compliance', category='Violations',
    ...
    high_level_metrics.update({
        'time_to_collision_within_bound': TimeToCollisionStatistics(name='time_to_collision_within_bound',
                                                                    category='Planning', metric_score_unit='bool',
                                                                    ...
                                                                    high_level_metrics['no_ego_at_fault_collisions'])})
