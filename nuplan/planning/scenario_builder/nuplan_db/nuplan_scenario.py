...
from nuplan.database.nuplan_db.nuplan_scenario_queries import (
    ...
    get_timestamps_with_scenario_tag_from_db,
)
...
class NuPlanScenario(AbstractScenario):
    ...
    def get_scenario_at_timestamps(self, timestamp) -> List[str]:
        return cast(
            Generator,
            get_timestamps_with_scenario_tag_from_db(self._log_file, timestamp)
        )
